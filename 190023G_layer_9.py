...
# %% [markdown]
# ### LogisticRegression & PCA will use for the label1's classification
...
# %%
test_pca1 = pca.transform(test_df1)
...
# %%
label1_predictions = logistic_classifier.predict(test_pca1)
...
# %%
merged_df.to_csv('190023G_layer_9.csv', index=False)
